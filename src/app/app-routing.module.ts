...
const ROUTES : Routes = [
  { path : '', pathMatch : 'full', redirectTo : 'FanFiction.com/about' },
  { path : 'FanFiction.com', pathMatch : 'full', redirectTo : 'FanFiction.com/about' },
  { path : 'FanFiction.com/about', loadChildren : async() : Promise<AboutModule> => await import('@about/about.module').then((aboutModule) => aboutModule.AboutModule) }
];
