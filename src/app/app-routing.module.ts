...
const ROUTES : Routes = [
  { path : 'FanFiction.com', pathMatch : 'full', redirectTo : 'fan-fiction/about' },
  ...
  { path : 'fan-fiction/about', loadChildren : async() : Promise<AboutModule> => await import('@about/about.module').then((aboutModule) => aboutModule.AboutModule) }
];
